 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * ⚠️ RÉPLIQUÉ DEPUIS `api-paynoval/src/services/errorTracking.js`.
 * Toute correction du filtrage doit être reportée dans les trois copies : deux
 * copies qui divergent sur ce qu'elles considèrent comme sensible, c'est une
 * fuite dans celle qui a pris du retard.
 *
